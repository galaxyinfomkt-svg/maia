  ...
  // ---------------------------------------------------------------- Atkinson, NH
  {
    ...
    gallery: [
      ...
      { src: `${BA}/siding-atkinson-nh-sheathing.webp`,
        ...
        caption: 'Stripped to the original plank sheathing, sill flashed, before insulation.' },
    ],
  },
  ...
  // ---------------------------------------------------------------- Woburn, MA
  {
    ...
    gallery: [
      ...
      { src: `${BA}/trim-woburn-ma-detail.webp`,
        alt: 'Close detail of custom PVC arch trim over EnergyShield insulation in Woburn, MA',
        caption: 'The arch trim up close, sitting on the insulation board.' },
