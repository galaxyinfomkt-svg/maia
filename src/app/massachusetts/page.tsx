...
export const metadata: Metadata = {
  title: 'Massachusetts Service Areas | 100+ Cities | Maia Construction',
  description: `Maia Construction serves 100+ Massachusetts cities — Boston, Worcester, Framingham, Natick, Marlborough & more. ★5.0 rated, same-day estimates. Licensed HIC #204634. Call for FREE quote!`,
  keywords: [
  ...
  alternates: {
    canonical: 'https://maiaconstruction.com/massachusetts',
  },
};
...
export default function MassachusettsPage() {
  ...
  const areaServedSchema = {
    ...
    '@type': 'ItemList',
    name: 'Massachusetts Cities Served by Maia Construction',
  ...
  return (
    <>
      ...
      <Hero
        title="Massachusetts Service Areas"
      ...
      <section className="py-16 bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <p className="text-5xl font-bold text-amber-400 mb-2">14</p>
              <p className="text-white/80">Counties Covered</p>
            </div>
            <div>
              <p className="text-5xl font-bold text-amber-400 mb-2">{services.length}</p>
              <p className="text-white/80">Services Offered</p>
            </div>
            <div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Our Services Across Massachusetts</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-amber-400 to-yellow-300 mx-auto mb-6" />
            <p className="text-xl text-gray-600">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">All Massachusetts Cities A-Z</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-amber-400 to-yellow-300 mx-auto mb-6" />
          </div>
